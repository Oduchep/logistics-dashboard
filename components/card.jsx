...
const Card = ({bgHover, textHover, heading, number, joined, iconbg, icon}) => {
  return (
        <div className={`relative w-64 mt-6 mx-auto lg:mx-0 rounded bg-white px-4 py-5 overflow-hidden text-slate-800 transition-colors duration-500 ${bgHover} ${textHover}`}>
