...
const Card = ({bgHover, textHover, heading, number, joined, iconbg, icon}) => {
  return (
        <div className={`relative w-72 mt-6 mx-auto md:mx-5 lg:mx-0 rounded bg-white px-6 py-5 overflow-hidden text-slate-800 transition-colors duration-500 ${bgHover} ${textHover}`}>
